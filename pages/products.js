...
const Products = ({cart}) => {
    ...
    return (
            <div className={"grid grid-cols-4 gap-24 container m-auto"}>

                {arrIteams.map((iteam, index) => {

                    return (
                            <a href={iteam.thumbnail} className={"box-product"}> <Image src={iteam.thumbnail}
                                alt={iteam.description} className="w-100 rounded-full" width={320} height={280}></Image>
